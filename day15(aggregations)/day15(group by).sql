...
INSERT INTO demo.education (std_name, department, fees, city, join_date) VALUES
...
select count(department) from demo.education;
select city,count(*) as totaltable,count(distinct std_name) , sum(fees) as totalfees
from demo.education
group by city
order by city;
drop table demo.education cascade;